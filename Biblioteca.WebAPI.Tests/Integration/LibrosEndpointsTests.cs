...
public class LibrosEndpointsTests : IClassFixture<CustomWebApplicationFactory>
{
    ...
    public async Task Admin_CRUD_Libros()
    {
        ...
        var crearAutor = new CrearAutorDto{ Nombre = $"A-{suffix}", Apellido = $"B-{suffix}" };
        ...
        var crearGenero = new CrearGeneroDto{ Nombre = $"G-{suffix}" };
        ...
        var crearEditorial = new CrearEditorialDto{ Nombre = $"E-{suffix}" };
        ...
        // Crear libro (ISBN y título únicos)
        var isbn = System.Guid.NewGuid().ToString("N");
        var crearLibro = new CrearLibroDto { Titulo = $"T-{suffix}", ISBN = isbn, AutorId = autor.Id, GeneroId = genero.Id, EditorialId = editorial.Id, Estado = "disponible" };
        ...
        var update = new LibroDto { Id = created.Id, Titulo = $"TT-{suffix}", ISBN = isbn, AutorId = autor.Id, GeneroId = genero.Id, EditorialId = editorial.Id, Estado = "disponible" };
